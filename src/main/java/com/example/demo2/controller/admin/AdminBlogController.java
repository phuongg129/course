...
//thay thu muc location thành thư mục của bản thân
@WebServlet(name = "adminBlog", urlPatterns = "/admin/blog")
@MultipartConfig(
        location = "C:\\Users\\ASUS\\Downloads\\echhocbai1\\demo2\\src\\main\\webapp\\public\\image",
...
public class AdminBlogController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (request.getParameter("update_blog") != null) {
            Blog blog = new Blog();
            blog.setId(Integer.parseInt(request.getParameter("update_b_id")));
            ...
            if (part != null && part.getSize() > 0) {
                ...
                String filePath = getServletContext().getRealPath("/") + "public/image/" + fileName;
                part.write(filePath);
