...
<section class="blog" id="blog">
    ...
    <div class="post container">
        ...
        <div class="post-box tech">
            <img href="/blog1" src="${pageContext.request.contextPath}/public/image/<%= row.getImg() %>" alt="" class="post-img">
            <h2 class="category"><%= row.getType() %></h2>
            <a href="/blog1" class="post-title" ><%= row.getImg_title() %></a>
            <span class="post-date">Jan 2024</span>
            <p class="post-description"><%= row.getContent() %></p>
            <div class="profile">
                <img src="${pageContext.request.contextPath}/public/image/user-icon.png" alt="" class="profile-img">
